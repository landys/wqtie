...
<body title="罗密欧和朱丽叶的结婚喜帖" icon="http://weiyaoqing.com/img/upload/case.1376325730.jpg" link="http://weiyaoqing.com/index.php/show/preview/location/type/1/tid/2/cid" desc="2013年05月01日   中国北京朝阳区北四环中路27号，盘古大观">
<!--婚礼模版二-->
...
<a href="javascript:void(0);" id="music" onclick="stop();"><img id="music_button" style="float: right" src="./tid2_address_files/music_stop.png"></a>
...
<script type="text/javascript" src="./tid2_address_files/api"></script><script type="text/javascript" src="./tid2_address_files/getscript"></script><link rel="stylesheet" type="text/css" href="./tid2_address_files/bmap.css">
...
<p>本喜帖由“<a class="about_color" href="http://weiyaoqing.com/" target="_blank">微邀请</a>”幸福提供<br>
    ...
    <a class="about_color" href="http://weiyaoqing.com/" target="_blank"><img style="width: 80px;" src="./tid2_address_files/weixin.jpg"></a>
</div>
